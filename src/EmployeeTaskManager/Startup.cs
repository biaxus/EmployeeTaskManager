...
namespace EmployeeTaskManager
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            ApplicationDbContext context = (ApplicationDbContext)app.ApplicationServices.GetService<ApplicationDbContext>();
            var list = context.Employee.Add(new Employee { Name = "Lopez Helver", Position = "Desarrollador" });
            context.SaveChanges();
        }
    }
}
